...
TEST_F(NameSpaceTest, RemoveFile) {
    ...
    ASSERT_NE(kOK, ns.RemoveFile("/file2",&file_removed));
    ASSERT_NE(kOK, ns.RemoveFile("/file3",&file_removed));
}
...
TEST_F(NameSpaceTest, DeleteDirectory) {
    ...
    // Delete subdir
    ASSERT_EQ(kOK, ns.DeleteDirectory("/dir1/subdir2", true, &files_removed));
    ...
    ASSERT_EQ(kNotOK, ns.DeleteDirectory("/file1", true, &files_removed));
